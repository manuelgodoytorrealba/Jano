...
| Draft → Library / Knowledge     | referencias editoriales selectivas y trazables           | investigador                      | copiar corpus o adquirir conocimiento |
...
- La derivación hacia Publication importa una `DraftRevision` o un fragmento identificable; nunca un Draft mutable. La composición importada pasa a ser propiedad de Publication.

# Research Entity Extraction Benchmark — baseline-current-02
...
- Dataset: 1.0.0
- Run status: FAILED — Ollama no devolvió JSON válido
- Pipeline: `{"task":"research.extract_findings","contractVersion":"3","maxCorpusSegments":80,"maxSegmentChars":1400,"evidenceBatchSize":5,"maxOutputTokens":1200,"entityOutputLimitPerBatch":6,"temperature":0.2,"promptAndContractHash":"0d40225b136338f4cc0ac577753838407d8f7b2f1f50544d1cd604cf7536905b","providerMetadata":{"provider":"ollama","model":"qwen2.5:7b"}}`

## Global metrics

- Documents: 6
- GOLD identities expected: 43
- Raw ENTITY proposals: 0
- Detected GOLD identities: 0
- Precision: —
- Recall: 0.0%
- F1: —
- Central recall: 0.0%
- Kind accuracy: —
- Duplicate proposals: 0 (0.0%)
- False/unmatched entities: 0
- Draft score average (heuristic): —/5

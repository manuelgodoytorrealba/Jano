# Research Entity Extraction Benchmark — baseline-relation-enum-v1-r2
...
- Detected GOLD identities: 23
- Precision: 84.4%
- Recall: 53.5%
- F1: 65.5%
- Central recall: 59.3%
- Kind accuracy: 92.6%
- Duplicate proposals: 4 (12.5%)
- False/unmatched entities: 5
- Draft score average (heuristic): 1.59/5
...
- GOLD: 6; central: 4
- Raw proposals: 4; matched identities: 2
- False/unmatched: 2; duplicates: 0
- Central recall: 1/4
- Coverage: 100.0% (4/4 segmentos)
...
- GOLD: 8; central: 6
- Raw proposals: 11; matched identities: 6
...
- Score: 4/5; contexto: CONTEXT_COMPLETE
- Summary: Ana Soler presentó una instalación titulada 'El eco quieto' y moderó una conversación titulada 'Eco quieto, sin artículo'.
...
- Score: 4/5; contexto: CONTEXT_COMPLETE
- Summary: El eco quieto es una instalación formada por dos superficies metálicas y un sistema de vibración que se activa cuando la sala queda momentáneamente vacía.
- Forbidden hits: ninguno
...
- Score: 4/5; contexto: CONTEXT_COMPLETE
- Summary: Faro Bajo es la localidad donde se encuentra el edificio ocupado por Casa Faro.
- Forbidden hits: ninguno
...
- Score: 4/5; contexto: CONTEXT_COMPLETE
- Summary: Casa Faro es la organización anfitriona de las Jornadas del Eco y gestiona residencias y encuentros.
- Forbidden hits: ninguno
...
- Summary: Aina Soler se ocupó del programa y de las sesiones de lectura en las Jornadas del Eco.
- Forbidden hits: ninguno
...
- GOLD: organization-galeria-umbral; kind: ORGANIZATION (correcto)
- Score: 1/5; contexto: CONTEXT_COMPLETE
- Summary: —
- Forbidden hits: ninguno
